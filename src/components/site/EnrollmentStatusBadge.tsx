...
const map: Record<EnrollmentStatus, { label: string; cls: string }> = {
  ...
  "documenti-mancanti": { label: "Documenti mancanti", cls: "bg-flame/15 text-flame border-flame/30" },
  ...
  "annullata":          { label: "Annullata",         cls: "bg-destructive/10 text-destructive border-destructive/30" },
};
