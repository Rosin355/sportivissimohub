  ...
  return (
    <div className="relative flex gap-4 items-start">
      ...
      <div className="relative shrink-0">
        <div className={`w-14 h-14 rounded-xl grid place-items-center shadow-sticker ${gradientClass[color]}`}>
      ...
      <div className={`flex-1 bg-white rounded-xl border border-border border-l-[3px] ${accentBorder[color]} shadow-card p-4`}>
