...
const defaultDayPlan: DayBlock[] = [
  { time: "07:30 - 09:00", title: "Buongiorno e accoglienza", description: "Anticipo facoltativo, giochi liberi e merenda di benvenuto.", icon: "sun",   color: "sun"   },
  { time: "09:00 - 12:30", title: "Sport & avventura",        description: "Attività sportive a rotazione: calcio, pallavolo, atletica.", icon: "ball",  color: "grass" },
  { time: "12:30 - 14:00", title: "Pranzo in compagnia",      description: "Mensa con menù controllato e momento di relax.",              icon: "lunch", color: "flame" },
  { time: "14:00 - 16:00", title: "Laboratori creativi",      description: "Arte, musica, costruzioni e mini-esperimenti.",              icon: "art",   color: "magic" },
  { time: "16:00 - 17:30", title: "Giochi di squadra",        description: "Tornei, cacce al tesoro e sfide a squadre.",                 icon: "team",  color: "royal" },
  { time: "17:30 - 18:30", title: "Saluti e posticipo",       description: "Ritiro bambini, posticipo facoltativo fino alle 18:30.",     icon: "hug",   color: "sun"   },
];
...
function base(partial: Partial<Location> & Pick<Location, "slug" | "name" | "comune">): Location {
  return {
    ...
    activities: ["Calcio", "Pallavolo", "Atletica", "Laboratori creativi", "Cacce al tesoro", "Giochi d'acqua"],
    includedServices: defaultIncluded,
    extraServices: defaultExtras,
    requiredDocuments: defaultDocs,
    contacts: { phone: "+39 049 0000000", email: "info@sportivissimo.it", manager: "Lo staff Sportivissimo" },
    faq: [
      { q: "Posso iscrivere più di una settimana?", a: "Sì, basta selezionare tutte le settimane desiderate nel modulo di iscrizione." },
      { q: "Il pranzo è incluso?", a: "Il pranzo è un servizio extra opzionale: puoi attivarlo durante l'iscrizione." },
      { q: "Posso ritirare prima mio figlio?", a: "Certo. Puoi indicarlo allo staff anche la mattina stessa." },
      { q: "Cosa serve per partecipare?", a: "Servono solo abbigliamento sportivo, cappellino, borraccia e tanta voglia di divertirsi!" },
    ],
    theme: "royal",
    ...partial,
  };
...
export const LOCATIONS: Location[] = [
  base({
    slug: "galzignano-terme", name: "Galzignano Terme", comune: "Galzignano Terme (PD)",
    address: "Via Roma 12 — Galzignano Terme",
    age: "6-13 anni", ageMin: 6, ageMax: 13,
    tagline: "Centro estivo immerso nel verde dei Colli Euganei.",
    pricePerWeek: 130, totalSpots: 60, bookedSpots: 46,
    badges: [
      { label: "Sport", color: "flame" },
  ...
  base({
    slug: "castegnero-champions-camp", name: "Castegnero Champions Camp", comune: "Castegnero (VI)",
    address: "Via dello Stadio 4 — Castegnero",
    age: "8-14 anni", ageMin: 8, ageMax: 14,
    tagline: "Il camp per i veri campioni del pallone.",
    pricePerWeek: 150, totalSpots: 50, bookedSpots: 28,
    badges: [
      { label: "Calcio", color: "grass" },
      { label: "Squadra", color: "magic" },
      { label: "Tornei", color: "flame" },
    ],
    activities: ["Allenamenti calcio", "Tecnica individuale", "Mini tornei", "Video analisi", "Fair play"],
    theme: "flame",
  }),
  base({
    slug: "san-pietro-viminario", name: "S. Pietro Viminario", comune: "San Pietro Viminario (PD)",
    address: "Piazza della Pace 2 — S. Pietro Viminario",
    age: "5-11 anni", ageMin: 5, ageMax: 11,
    tagline: "Tanti laboratori creativi per piccoli artisti.",
    pricePerWeek: 115, totalSpots: 45, bookedSpots: 36,
    badges: [
  ...
  base({
    slug: "vo-euganeo", name: "Vo' Euganeo", comune: "Vo' (PD)",
    address: "Via dei Colli 7 — Vo' Euganeo",
    age: "6-12 anni", ageMin: 6, ageMax: 12,
    tagline: "Avventure nel cuore dei Colli Euganei.",
    pricePerWeek: 120, totalSpots: 40, bookedSpots: 22,
    badges: [
      { label: "Natura", color: "grass" },
      { label: "Avventura", color: "flame" },
      { label: "Trekking", color: "sun" },
    ],
    activities: ["Trekking", "Orienteering", "Giochi nel bosco", "Sport di squadra", "Laboratori natura"],
    theme: "grass",
  }),
  base({
    slug: "asigliano-veneto", name: "Asigliano Veneto", comune: "Asigliano Veneto (VI)",
    address: "Via della Scuola 5 — Asigliano Veneto",
    age: "5-11 anni", ageMin: 5, ageMax: 11,
    pricePerWeek: 110, totalSpots: 35, bookedSpots: 23,
    badges: [
      { label: "Sport", color: "flame" },
      { label: "Creatività", color: "magic" },
    ],
  ...
  base({
    slug: "sossano", name: "Sossano", comune: "Sossano (VI)",
    address: "Via dello Sport 3 — Sossano",
    pricePerWeek: 125, totalSpots: 40, bookedSpots: 33,
    badges: [
      { label: "Piscina", color: "royal" },
  ...
  base({
    slug: "orgiano", name: "Orgiano", comune: "Orgiano (VI)",
    address: "Via Marconi 9 — Orgiano",
    age: "5-12 anni", ageMin: 5, ageMax: 12,
    pricePerWeek: 115, totalSpots: 38, bookedSpots: 22,
    badges: [
      { label: "Sport", color: "flame" },
      { label: "Natura", color: "grass" },
    ],
  ...
  base({
    slug: "noventa-vicentina", name: "Noventa Vicentina", comune: "Noventa Vicentina (VI)",
    address: "Via Roma 22 — Noventa Vicentina",
    pricePerWeek: 135, totalSpots: 55, bookedSpots: 35,
    badges: [
  ...
  base({
    slug: "bastia-frassanelle", name: "Bastia / Frassanelle", comune: "Rovolon (PD)",
    address: "Via Frassanelle 1 — Rovolon",
    age: "7-14 anni", ageMin: 7, ageMax: 14,
    pricePerWeek: 140, totalSpots: 45, bookedSpots: 34,
    badges: [
      { label: "Avventura", color: "flame" },
      { label: "Natura", color: "grass" },
    ],
