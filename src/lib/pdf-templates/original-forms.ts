...
export async function buildGalzignanoOriginalPdf(e: Enrollment): Promise<Uint8Array> {
  const template = loadGalzignano2026Template();
  return renderOverlay(template, [...galzignanoEnrollmentOps(e), ...acsiMinorOps(e)]);
}
