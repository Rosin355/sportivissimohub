...
-- I ruoli vivono in una tabella dedicata (mai in user_metadata): il client non può
-- alterarli perché user_roles è scrivibile solo da admin via RLS.
...
-- security definer: le policy possono controllare i ruoli senza ricorsione su user_roles
...
-- Alla registrazione: riga in profiles (dati da raw_user_meta_data) e ruolo di
-- default 'genitore' (privilegio minimo; staff/admin si assegnano manualmente).
