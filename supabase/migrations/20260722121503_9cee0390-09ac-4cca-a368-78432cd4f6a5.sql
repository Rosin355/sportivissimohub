-- M2a — Schema applicativo (tabelle public, senza bucket storage)
...
grant select, insert, update, delete on public.pickup_delegates to authenticated;
grant all on public.pickup_delegates to service_role;
...
grant select, insert, update, delete on public.enrollment_documents to authenticated;
